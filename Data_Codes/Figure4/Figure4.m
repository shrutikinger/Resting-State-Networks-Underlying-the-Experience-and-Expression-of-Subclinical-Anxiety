%% FIGURE 4: Correlation matrix (4B) and ring connectome (4C)
% -------------------------------------------------------------------------
% This script reproduces Figure 4B and 4C from the manuscript and completes:
%   - visualization 
...
%
% OUTPUT:
%   - Figure replicating Figure 4B and 4C
%   
%
...
%% --------------------------- LOAD DATA ----------------------------------
file = readtable("ROIs.xlsx",Sheet="SCR_UTxanxiety");
