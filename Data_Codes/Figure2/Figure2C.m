%% FIGURE 2C: SCR plot
% -------------------------------------------------------------------------
% This script reproduces Figure 2C from the manuscript and completes:
...
ylabel('Skin Conductance Response (SCR)', 'FontSize', 13);
ax= gca;
ax.LineWidth = 1.5;
ax.TickDir ='out'
...
exportgraphics(gca, 'Figure2C.tiff','Resolution',300)