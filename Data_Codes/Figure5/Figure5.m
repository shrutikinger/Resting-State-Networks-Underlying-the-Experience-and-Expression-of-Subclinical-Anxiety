%% FIGURE 4: Correlation matrix (5B) and ring connectome (5C)
% -------------------------------------------------------------------------
% This script reproduces Figure 5B and 5C from the manuscript and completes:
%   - visualization 
...
%                hideClassLabels.m, brewermap.m in current directory
%
%
% OUTPUT:
%   - Figure replicating Figure 5B and 5C
%   
%
...
%% --------------------------- LOAD DATA ----------------------------------
file = readtable("ROIs.xlsx",Sheet="anxiety");
